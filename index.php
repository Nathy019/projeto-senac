...
<div id="historia">
    <div class="card text-bg-secondary bg-opacity-10 m-5 p-2" style="max-width: 540rem;">
        <div class="row g-0">
            ...
            <div class="col-md-8">
                <div class="card-body">
                    <a href="#body" class="link-light link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0">
                        <h2 class="card-title text-center p-5">Prazer sou Daniel</h2>
                    </a>
